...
void i2c_read(i2c_dev_t *dev, i2c_msg_t *reg_addr, i2c_msg_t *data)
{
    ...
    // 准备发送寄存器地址
    i2c->tx_buf = reg_addr->buf;
    i2c->i2c->TXDR = *i2c->tx_buf++;

    // 开始发送
    LL_I2C_HandleTransfer(i2c->i2c, i2c->dev_addr, LL_I2C_ADDRESSING_MODE_7BIT, reg_addr->len, LL_I2C_MODE_SOFTEND, LL_I2C_GENERATE_START_WRITE);
...
void i2c_write(i2c_dev_t *dev, i2c_msg_t *data)
{
    ...
    LL_I2C_HandleTransfer(i2c->i2c, dev->dev_addr, LL_I2C_ADDRESSING_MODE_7BIT, data->len, LL_I2C_MODE_AUTOEND, LL_I2C_GENERATE_START_WRITE);
...
void i2c_irq(struct stm32_i2c *i2c)
{
    ...
    else if ((flags & I2C_ISR_TC) && (sources & I2C_CR1_TCIE))
    {
        ...
        // 一次最多传输255个字节
        LL_I2C_HandleTransfer(i2c->i2c, i2c->dev_addr, LL_I2C_ADDRESSING_MODE_7BIT, i2c->rx_len, LL_I2C_MODE_AUTOEND, LL_I2C_GENERATE_START_READ);
    }
