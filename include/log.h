...
#define LOG_E(format, ...)    log_printf(LOG_COLOR_RED"[E]:"format""LOG_COLOR_NONE, ##__VA_ARGS__)
#else
#define LOG_E(...)
#define log_init(a, b)
#endif
...
#if LOG_LEVEL > 1
#define LOG_W(format, ...)     log_printf(LOG_COLOR_YELLOW"[W]:"format""LOG_COLOR_NONE, ##__VA_ARGS__)
#else 
#define LOG_W(format, ...)
#endif
